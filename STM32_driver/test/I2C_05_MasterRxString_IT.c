...
void EXTI15_10_IRQHandler(void)
{
	...
	//Send command 0x51
	cmd = 0x51;
	__I2C_MasterSend_IT(&I2C1_handle, &cmd, 1, SAddr, I2C_ENABLE_SR);
	cmdCounter = 1;
}
...
{
	if(AppEv == I2C_EVENT_TC)
	{
		if(cmdCounter == 1)
		{
			//receive string size
			__I2C_MasterReceive_IT(&I2C1_handle, &ssize, 1, SAddr, I2C_ENABLE_SR);
			cmdCounter = 2;
		}
		...
		{
			//receive string
			__I2C_MasterReceive_IT(&I2C1_handle, String, ssize, SAddr, I2C_DISABLE_SR);
			cmdCounter = 0;
		}
	}
...
void setup()
{
	...
	__I2C_IRQconfig(&I2C1_handle, EN, 0);
	__GPIO_IRQconfig(13, EN, 1);
}
